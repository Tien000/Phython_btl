...
CREATE DATABASE [DEMO_IOT]
 CONTAINMENT = NONE
 ON  PRIMARY 
( NAME = N'DEMO_IOT', FILENAME = N'D:\python btl' , SIZE = 8192KB , MAXSIZE = UNLIMITED, FILEGROWTH = 65536KB )
 LOG ON 
( NAME = N'DEMO_IOT_log', FILENAME = N'D:\python btl' , SIZE = 8192KB , MAXSIZE = 2048GB , FILEGROWTH = 65536KB )
